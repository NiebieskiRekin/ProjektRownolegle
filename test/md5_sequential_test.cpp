...
TEST(MD5Test, MD5Test1) {
    ...
    void* sig2 =hash_sequential("The quick brown fox jumps over the lazy dog");
    // Test with cassert whether sig is correct from the expected value
    ...
    void* sig3 = hash_sequential("The quick brown fox jumps over the lazy dog.");
    // Test with cassert whether sig is correct from the expected value
    ...
    void* sig4 = hash_sequential("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
    // Test with cassert whether sig is correct from the expected value
