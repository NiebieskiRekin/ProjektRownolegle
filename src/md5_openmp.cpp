...
std::array<uint8_t, 16> hash_openmp(const void *input_bs, uint64_t input_size){
    ...
    merkleTreeReduce(chunk_states);
    const auto& final_state = chunk_states[0];
