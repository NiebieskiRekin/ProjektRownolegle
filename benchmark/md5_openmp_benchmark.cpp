...
static void BM_OpenmpMD5_Tiny(benchmark::State& state) {
...
BENCHMARK(BM_OpenmpMD5_Tiny)->RangeMultiplier(2)->Range(8, 8 * 1024);
...
BENCHMARK(BM_OpenmpMD5_Small)->RangeMultiplier(4)->Range(16 * 1024, 256 * 1024);
...
BENCHMARK(BM_OpenmpMD5_Medium)->RangeMultiplier(8)->Range(512 * 1024, 4 * 1024 * 1024);
...
BENCHMARK(BM_OpenmpMD5_Large)->RangeMultiplier(8)->Range(2 * 1024 * 1024, 4 * 1024UL * 1024UL * 1024UL);